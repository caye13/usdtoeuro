...
class convertCurrencyTextField: UITextField {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        let calculateButton = UIBarButtonItem(title: "Convert Currency", style: .done, target: self, action: #selector(calculateButtonTapped(_:)))
